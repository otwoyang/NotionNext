...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，7你好!🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'NotionNext', // 您的昵称 例如 
  BIO: process.env.NEXT_PUBLIC_BIO || '在倾诉中找到 结论 和 轻松', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-coral-alpha.vercel.app/', // 网站地址
  ...
  COMMENT_CUSDIS_APP_ID: process.env.NEXT_PUBLIC_COMMENT_CUSDIS_APP_ID || '1bcfc48a-3ad9-48c2-b9f7-962b8625bf85', // data-app-id 36位 see https://cusdis.com/
  COMMENT_CUSDIS_HOST:
